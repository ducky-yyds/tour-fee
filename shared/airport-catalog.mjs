/** Expand airport coverage without presenting unavailable city prices as free. */
export function mergeAirportCities(curated = [], airportCities = []) {
